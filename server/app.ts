...
const allowedDomains = [
  env.NODE_ENV === "production" ? "https://intellisense.e-cpta.mn/" : "http://localhost:3000",
  env.NODE_ENV === "production" ? "https://admin-intellisense.e-cpta.mn" : "http://localhost:3001",
];
app.use(
  cors({
