  ...
  <div className="container">
    <div className="flex items-center justify-between pt-[120px] pb-[46px]">
      <div>
        ...
        <p className="text-md-regular text-text">Lorem ipsum dolor sit amet, consectetur</p>
      </div>
      <ArrowButton className="bg-color-1/[.07] text-color-1">Browse Blog</ArrowButton>
    </div>
    <div className="grid grid-cols-3 gap-[15px] pb-[112px]">
      <div className="flex flex-col gap-[10px]">
        <Image src={bimage} alt="" className="rounded-xl pb-[5px]" width={435} height={354} />
        <p className="text-color-1 text-sm-medium pb-[10px] uppercase">Education</p>
      ...
      <div className="flex flex-col justify-between">
        <div className="flex items-center justify-between">
          <Image src={bimage} alt="" className="rounded-xl " width={155} height={157} />
          <div className="pl-[10px]">
            <h1 className="text-color-1 text-xs-medium uppercase pb-[10px]">Courses</h1>
        ...
        <div className="flex items-center justify-between">
          <Image src={bimage} alt="" className="rounded-xl " width={155} height={157} />
          <div className="pl-[10px]">
            <h1 className="text-color-1 text-xs-medium uppercase pb-[10px]">Design</h1>
            <h3 className="text-head text-lg-medium pb-[10px]">
              Medical Chemistry: The Molecular Basis
            </h3>
            <p className="text-text text-md-regular">December 16, 2022</p>
...
export default ResourcesNewsSection;
