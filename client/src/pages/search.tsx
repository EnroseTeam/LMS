...
const SearchPage: FC<SearchPageProps> = ({ searchItems, totalPage, totalSearch }) => (
  <>
    <Breadcrumbs breadcrumbItems={[{ title: "Хайлт", link: "/search" }]} />
    <div className="container">
      <h1 className="text-center text-head font-[700] text-[30px] smallest:text-[40px] leading-[47px] mb-1">
        Хайлтын үр дүн
      </h1>
      ...
      {totalSearch > 0 && (
        <div className="grid grid-cols-1 smallest:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] mb-[60px]">
      ...
      {totalSearch === 0 && (
        <p className="text-center mb-[120px] text-text text-md-medium">Илэрц олдсонгүй</p>
      )}
      {totalSearch > 0 && (
