    ...
    if (!isSubmitting) {
      try {
        ...
        if (!email || !password) {
          ...
          if (!password) setIsPasswordExist(false);
          return;
        }

        const res = await axiosInstance.post("/api/auth/login", { email, password, remember });
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <div className="mb-5.5 inline-block">
                <Image src={logoMain} alt="Logo" className="hidden dark:block" />
                <Image src={logoBlack} alt="Logo" className="dark:hidden" />
              </div>
              <p className="font-medium 2xl:px-20">Ажил хийвэл дуустал, давс хийвэл уустал.</p>
              ...
              >
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={classNames(
                        ...
                        { "ring-2 ring-danger border-none": !isEmailExist }
                      )}
                    />
                    {!isEmailExist && (
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={classNames(
                        "w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary",
                        { "ring-2 ring-danger border-none": !isPasswordExist }
                      )}
                    />
                    {!isPasswordExist && (
                      <p className="mt-2 text-sm text-danger font-medium">
                ...
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="remember">Намайг санах</label>
                  </div>

                  <Link
                    className="underline text-sm text-primary dark:text-white duration-150"
                    href={"/"}
                  >
                    Нууц үг сэргээх
                  </Link>
                ...
                <div className="mb-5">
                  <button
                    ...
                    type="submit"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90 disabled:bg-primary/50 disabled:border-primary/50 disabled:pointer-events-none"
                  >
                    Нэвтрэх
                  </button>
                </div>
